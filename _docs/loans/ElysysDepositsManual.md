...
<b>General FastTab:</b><br> 
    ...
    - select the Portfolio and the Instrument dimensions to be used. These 2 dimensions will be used to track all entries generated by the system when posting a deposit’s capital and interest payments. If the Dimensions do not exist, you will need to create them.<br> <br> 
...
<b> Deposits FastTab:</b>  <br> 
    ...
    - Deposit Nos.: Select a number series for this field to number all new deposits. This will be used to create the instrument code which will be used to track the deposit throughout the system. <br> <br> 
